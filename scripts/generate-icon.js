'use strict';
/**
 * Generates build/icon.ico, build/icon.png and
 * src/assets/icons/tray.png for the app.
 *
 * Design: a large brand-red "L" letter on a transparent background.
...
fs.writeFileSync(path.join(trayDir,  'tray.png'), png);

console.log('✅  build/icon.ico              (app icon "L" — 256px)');
console.log('✅  build/icon.png              (app icon "L" — 256px)');
console.log('✅  src/assets/icons/tray.png   (tray icon "L" — 256px)');
